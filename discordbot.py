...
async def on_ready():
    ...
    for channel in channels.channels:
        ...
        try:
            ...
            print(f'Failed to join channel: {channel.name}, {e}')
        ...
        for token in str(message.content).lower().split(" "):
            ...
            if similarity_score > 80:
                ...
                if "tenor" in str(message.content).lower():
                    ...
                    warning_message = f"The word [{bad_word}] is a not safe word, and it was found in the sentence: [{message.content}]. Therefore, Your message in the channel {message.channel.name} has been flagged and reported due to violation of the rules. If this was an error please PM the admin."
